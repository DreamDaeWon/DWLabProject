...
{
    ID3D12RootSignature* pd3dGraphicsRootSignature = NULL; D3D12_ROOT_PARAMETER pd3dRootParameters[3];
...
void CScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
    ...
    m_pTerrain = new CHeightMapTerrain(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 
        _T("../Image/HeightMap.raw"), 257, 257, 257, 257, xmf3Scale, xmf4Color);
    #endif
    m_nShaders = 1;
